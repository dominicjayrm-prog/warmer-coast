...
export const metadata: Metadata = {
  ...
  description: 'Our 30-day strong conditional refund policy. Honoured, simple to claim. Read the full mechanics here.',
...
export default function Page() {
  return (
    <LegalDoc
      eyebrow="Refunds"
      title="Refund policy"
      intro="Stronger than vanilla money-back. Honoured. Almost no one asks."
      updated="2026-05-19"
      sections={[
        ...
        { title: 'Why we can offer this', body: <p>Because the playbook works. Almost no one asks for a refund — the few who do are simple change-of-mind within the first week. We would rather refund honestly than play games with restrictive terms.</p> },
